  ...
  try {
    ...
    for (const item of pending) {
      try {
        ...
        console.info('[DOWNSELL][MEDIA_CHECK]', {
          queue_id: item.id,
          has_media_refs: !!item.media_refs,
          media_refs_type: typeof item.media_refs,
        ...
        if (mediaRefs.length > 0) {
          ...
          console.info('[DOWNSELL][WITH_MULTI_MEDIA]', { 
            queue_id: item.id,
            downsell_id: item.downsell_id,
          ...
          if (mediaResult.ok) {
            ...
            console.warn('[DOWNSELL][MEDIA_FAILED]', {
              queue_id: item.id,
              downsell_id: item.downsell_id,
